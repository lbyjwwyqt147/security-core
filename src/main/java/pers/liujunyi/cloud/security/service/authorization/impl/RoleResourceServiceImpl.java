 ...
 */
@Service
public class RoleResourceServiceImpl  extends BaseJpaMongoServiceImpl<RoleResource, Long> implements RoleResourceService {
    ...
    public RoleResourceServiceImpl(BaseJpaRepository<RoleResource, Long> baseRepository) {
